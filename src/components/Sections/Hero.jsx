    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden hero-section pt-16">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="flex flex-col items-center text-center">
          ...
          >
            A passionate <span className="text-primary-400 font-semibold">Full-Stack (MERN) / NEXT.JS Developer </span>crafting sleek, responsive, and scalable web applications. I blend modern design with powerful frontend and backend solutions to deliver seamless user experiences that make an impact.
          </motion.h2>
