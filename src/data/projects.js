...
import blackcart from ".././assets/blackcart.jpg";
export const featuredProjects = [
  ...
  },
  {
    ...
    description:
      "A modern photo editor app built with Next.js, featuring background removal, custom backgrounds, and editing adjustments.Edit your images effortlessly and download them in multiple formats (JPG, PNG, WebP). ",
  ...
  },
  {
    ...
    description:
      "Built a secure full-stack Blog Application with user authentication and seamless post management (CRUD). Delivered responsive UI, detailed post views, and optimized performance for an engaging user experience.",
    image: blog,
    tech: [
      "React",
      "Node.js",
...

  {
    ...
    description:
      "Developed a full-stack Fee Management System with real-time fee tracking and secure payment simulation. Designed a responsive interface to simplify student management and streamline transactions.",
    image: fee,
    tech: [
      "React",
      "Node.js",
...
export const allProjects = [
...

  {
    ...
    description:
      "An e-commerce website for a sunglasses store, featuring a sleek design and user-friendly interface. Showcases various sunglasses products with detailed views and smooth navigation. Built to provide an engaging shopping experience.",
    image: sunglasses,
  ...
  },
  {
    ...
    description:
      "Developed a CRUD app with Node.js, Express, MongoDB, and EJS for dynamic rendering. Enabled seamless create, read, update, and delete operations with a clean UI and efficient backend.",
    image: crud,
    tech: [
      "Node js",
      "Express js",
  ...
  },
  {
    ...
    description:
      "Built a responsive Currency Converter using HTML, CSS, and JavaScript with live exchange rate API integration. Delivered a simple, user-friendly interface for fast and accurate conversions.",
...

  {
    ...
    description:
      "Time to get your house clean and organized with ease. Designed to promote fresh living and better air quality through a modern, user-friendly interface. A clean, responsive UI that blends simplicity with functionality.",
    image: smartui,
  ...
  },
  {
    ...
    description:
      "Built a responsive Weather App delivering real-time forecasts with temperature, humidity, wind speed, and conditions. Designed with an intuitive interface for quick and accurate updates.",
    image: weather,
    tech: [
      "Html",
      "Css",
  ...
  },
  {
    ...
    description:
      "Designed a modern and visually appealing Coffee Shop website with HTML, CSS, and JavaScript. Focused on delivering an engaging user interface with smooth layouts and aesthetic visuals. Built as a static site to showcase brand identity and design creativity.",
    image: cofeeshop,
  ...
  },
  {
    ...
    description:
      "Crafted a sleek, responsive website for modern interior design, blending aesthetics with functionality. Showcased elegant, livable spaces to inspire and transform interiors.",
    image: furni,
    tech: [
      "Html",
      "Css",
  ...
  },
  {
    ...
    title: "Calculator",
    description:
      "A clean and responsive calculator built with HTML, CSS, and JavaScript. Designed for fast, accurate, and user-friendly calculations with a modern interface. Showcases core logic handling, interactive UI, and seamless usability across devices.",
    image: calculator,
  ...
  },
  {
    ...
    title: "Todo App",
    description:
      "A simple and efficient To-Do App designed for quick task management. Users can easily add new tasks and remove completed ones. Built with a clean UI to ensure a smooth and minimal experience.",
    image: todo,
...

  {
    ...
    description:
      "A secure password generator that creates strong, random passwords based on user-defined criteria. Features options for length and character types to ensure maximum security. Designed with a simple and intuitive interface for ease of use.",
    image: password,
  ...
  },
  {
    ...
    description:
      "A modern and informative university website designed to provide essential information about courses, faculty, and campus life. Features a clean layout and responsive design for easy navigation across devices.",
    image: uni,
  ...
  },
  {
    ...
    description:
      "An interactive Tic-Tac-Toe game built with a clean and responsive interface. Players can compete in a classic X vs O challenge with instant win detection. Designed for fun, simplicity, and smooth user experience.",
    image: tictoc,
  ...
  },
  {
    ...
    title: "User List App",
    description:
      "A user management application built with React and Redux Toolkit. Allows users to add and delete user data efficiently. Features a responsive design and seamless state management for an optimal user experience.",
    image: userlist,
    demoLink:
      "https://66eeb11433a5bb45b23d3880--preeminent-cuchufli-05af48.netlify.app/",
    codeLink:
      "https://github.com/mustafa-mmd/react-redux-Tolkit-add-delete-userData",
    tech: [
      "React",
      "Redux Tolkit",
      "Material Ui",
  ...
  },
  {
    ...
    description:
      "A sleek and modern chair store website designed to showcase a variety of chair designs. Features a clean layout, responsive design, and user-friendly navigation to enhance the shopping experience.",
    image: chair,
    ...
    tech: [
      ...
      "Css",
      "Responsive Design",
      "Logic for color changing of image",
      "E-commerce Design",
    ],
  },
];
