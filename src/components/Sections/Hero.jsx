...
//           >
//             Hi, I'm <span className="gradient-text animate-pulse">Mustafa Jamal</span>
//           </motion.h1>
...
//             className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-3xl leading-relaxed"
//           >
...
//               whileTap={{ scale: 0.95 }}
//               className="flex items-center justify-center gap-2 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
//             >
//               {isDownloading ? (
//                 <>
...
//               }}
//               whileTap={{ scale: 0.95 }}
//               className="border-2 border-primary-600 text-primary-400 hover:text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 shadow-lg"
//             >
//               View My Work
//             </motion.button>
//           </motion.div>
...
//                 }}
//                 whileTap={{ scale: 0.9 }}
//                 className="text-gray-400 hover:text-primary-400 transition-all duration-300 p-3 rounded-full bg-gray-800/50 hover:bg-gray-800/80 backdrop-blur-sm"
...
//       {/* Scroll Indicator  */}
//        <ParallaxEffect speed={20} className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
//         <motion.div
//           animate={{ y: [0, 15, 0] }}
...
//           <div className="w-6 h-10 border-2 border-primary-500 rounded-full flex justify-center items-start p-1">
//             <motion.div
//               animate={{ y: [0, 12, 0] }}
//               transition={{ repeat: Infinity, duration: 2.5, ease: "easeInOut" }}
